...
contract("KCoin", function (accounts) {
  ...
  it("transfers token ownership", () => {
    return KCoin.deployed()
      .then((instance) => {
        ...
        //.call does not create a transaction - data not modified
  ...
  it("handles delegated token transfers", () => {
    return KCoin.deployed()
      ...
      .then((receipt) => {
        //Try transerring something larger than the sender's balance
        //spendingAccount calling this fxn
